...
import (
	...
	"github.com/deke-create/qbit-gateway/docs"
...
type App struct {
	*baseapp.BaseApp
	...
	QbitgatewayKeeper qbitgatewaymodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		minttypes.StoreKey, distrtypes.StoreKey, slashingtypes.StoreKey, feegrant.StoreKey,
	...
	app.QbitgatewayKeeper = *qbitgatewaymodulekeeper.NewKeeper(
		appCodec,
		keys[qbitgatewaymoduletypes.StoreKey],
		keys[qbitgatewaymoduletypes.MemStoreKey],
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		capabilitytypes.ModuleName, feegrant.ModuleName,
	)
